...
- The release fixed 672x672 Vision graph accepts `(1,2304,588)` and emits 576
  visual tokens. The earlier 448 profile emitted 256 tokens, while an upstream
  dynamic-resolution example emitted 925 tokens.
