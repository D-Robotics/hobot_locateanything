...
from pipeline.coordinates import LanguageCoordinateAuditor
from pipeline.quantization import QuantizationEmulator, tensor_comparison
...
def create_language_model(
    ...
    from model.rotation import load_hidden_rotation
...
class LanguageEagerRunner:
    ...
    def _decode_inputs(
        ...
        *,
        ...
        from pipeline.replay import build_decode_inputs
    ...
    def _right_aligned(self, keys: list[Any], values: list[Any], active_len: int):
        from pipeline.replay import build_right_aligned_caches
